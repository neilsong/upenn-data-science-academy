...
The interpretation of a 95% confidence interval based on the simulation is essentially that 95% of the data captures the true mean of our expected game winnings, while 5% of the data is not representative of true mean.In this case, out of this simulation, 4 out of the 100 trials turned out to be not within the bounds of our confidence interval, but we were still able to maintain the 95% confidence interval. It turns out that we were 96% accurate, for this specific simulation and seed.
