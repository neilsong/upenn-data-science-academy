...
Probability of winning is 1/38, probablility of losing is 37/38
```{r}
one_num_expected_win <- print(35*1/38-37/38)

### wins standard deviation
n <- 1000
win_prob <- 1/38
# winning event
set.seed(1)
...
```{r}
twonum_expected_win <- print(35*2/38-36/38)
print(expected_win)
...
win_vec <- rbinom(n,1,win_prob) 
print(sum(win_vec))
### expect to win 1000/38 which is 26.3, so our answer is pretty close based on simulation.
```
