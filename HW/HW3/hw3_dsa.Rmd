...
Anova(fit3)
```
The f statistic produced by Anova function is 96.6 which is significantly larger than 1. Since an f statistic of 1 shows the null hypothesis, the very large f statistic shows that we can reject the null hypothesis and say that average of the three regions are different in a statistically significant way.
