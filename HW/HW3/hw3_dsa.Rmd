...
```
    ...
    + By first looking at origin we may think it is a continous variable as it is made up of the numbers 1,2 and 3. However it is a catagorical varibale and origin 1,2 and 3 mean different. 

i. Do you see any peculiarity in the data? 

    + Most of the dataset looks fine except that the origin is names 1,2 and 3 while we would think they would have distingushed names. This makes it rather different. 
...
```
    ...
    + Yes, the interaction effect is significant at .05 level. The year effect is best expressed as follows. $$ \Delta mpg = (\beta_1 + \beta_3hp) \cdot \Delta year $$
...
i. Describe on average which origin has the highest mpg and what it is. Which origin has the smallest mpg on average and what is it?
    + On an average origin 3 have the highest mpg of 30.451, and origin 1 has the lowest avegare mpg of 20.033. 