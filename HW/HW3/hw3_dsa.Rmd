...
```
By first looking at origin, we may think it is a continous variable as it is made up of the numbers 1, 2, and 3. However, it is a catagorical varibale and origin 1, 2, and 3 mean different, discrete regions. 

iii. Do you see any peculiarity in the data? 
Most of the dataset looks fine except that the origin is named 1, 2, and 3, while we would think they would have distingushed names. This makes it rather peculiar. 
