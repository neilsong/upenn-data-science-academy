...
I learned how to set up the base R environment and its corresponding IDE and package manager. I also learned basic R-markdown/R syntax, was introduced to a variety of R concepts including vectorization and dataframes, and overall learned a basic set of principles and functions that I could easily understand by translating prior knowledge in other languages.
