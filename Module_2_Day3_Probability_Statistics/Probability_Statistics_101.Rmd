...
Goal: Estimate the mean winning or test if the mean is -.056

How?

Data: Gather data by playing Red-Black game 100 times, we have observed:            
\footnotesize
```{r echo = T}
set.seed(1)
n <- 100
...
* Testing statistics
\[
t = \frac{\bar{X} - (-.0526)}{s/\sqrt{n}} = \frac{-.28 + .0526}{.965/sqrt{100}} = -.2357
\]
 
* $p\mbox{-value}=P(|T|> 2.357) =.0204$  if $\mu = -.0526$
